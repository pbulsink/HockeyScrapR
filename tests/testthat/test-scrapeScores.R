...
test_that("Testing scraping NHL scores", {
  ...
  expect_message(getAndSaveNHLGames(start = 2005, end = 2006, data_dir = "./",
    sleep = 10), "Can't collect 2004-2005. No season due to lockout. Collecting from 2005-2006 to there.")
  f1 <- "./20052006.csv"
  ...
  expect_message(getAndSaveNHLGames(start = 2004, end = 2005, data_dir = "./",
    sleep = 10), "Can't collect 2004-2005. No season due to lockout. Collecting to 2003-2004.")
  f1 <- "./20032004.csv"
  ...
  expect_message(getAndSaveNHLGames(start = 1917, end = 1918, data_dir = "./",
    sleep = 10), "NHL started in 1917-1918. Collecting data from there forwards.")
  f1 <- "./19171918.csv"
  ...
  expect_message(getAndSaveNHLGames(start = 2018, end = 2019, data_dir = "./",
    sleep = 10), "Can't start collecting data past next season. Collecting final season.")
  f1 <- "./20162017.csv"
  expect_true(file.exists(f1))
  try_delete(f1)

  expect_message(getAndSaveNHLGames(start = 2017, end = 2019, data_dir = "./",
    sleep = 10), "Can't collect past this season. Collecting up to there.")
  f1 <- "./20162017.csv"
  expect_true(file.exists(f1))
  try_delete(f1)
...
test_that("Testing scraping WHA scores", {
  ...
  expect_message(getAndSaveWHAGames(start = 1972, end = 1973, data_dir = "./",
    sleep = 10), "WHA started in 1972-1973. Collecting data from there forwards.")
  f1 <- "./wha19721973.csv"
  ...
  expect_message(getAndSaveWHAGames(start = 1980, end = 1981, data_dir = "./",
    sleep = 10), "WHA ended in 1978-1979. Collecting final season.")
  f1 <- "./wha19781979.csv"
  ...
  expect_message(getAndSaveWHAGames(start = 1979, end = 1981, data_dir = "./",
    sleep = 10), "WHA ended in 1978-1979. Collecting up to there.")
  f1 <- "./wha19781979.csv"
  f2 <- "./wha19781979Playoffs.csv"
  expect_true(file.exists(f1))
  expect_true(file.exists(f2))
